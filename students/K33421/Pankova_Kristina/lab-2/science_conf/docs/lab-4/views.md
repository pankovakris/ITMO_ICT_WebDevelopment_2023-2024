...
This documentation provides an overview of the views used in the Vue.js app.

## About View

### AboutView.vue

Description: View displaying information about the application.


## Registration Views

### OwnerRegistration.vue

Description: View for owner registration.
...
<template>
  <div class="app">
    ...
    <registration-owner-form class="form" />
  </div>
</template>
...
<script>
import RegistrationOwnerForm from "@/components/RegistrationOwnerForm.vue";
import UserComponent from '@/components/UserComponent.vue';
import axios from "axios";

export default {
 components: {
   RegistrationOwnerForm, UserComponent
 },
}
</script>
...
Description: View representing the home page of the application.
...
Description: View for displaying a list of salons.
